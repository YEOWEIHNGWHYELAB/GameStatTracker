"""
Django settings for gamestattrackerdb project.
...
SECRET_KEY = 'django-insecure-ahu-lu%lra9!a%e34&*@y8bg8ih18q%vnw#7!3b5)j=sz6j95z'
...
ROOT_URLCONF = 'gamestattrackerdb.urls'
...
WSGI_APPLICATION = 'gamestattrackerdb.wsgi.application'
